...
public class KechengPingfenEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KechengPingfenEntity() {

	}

	public KechengPingfenEntity(T t) {
		try {
    ...
    public String toString() {
        return "KechengPingfen{" +
            ...
            ", kechengId=" + kechengId +
            ", kechengPingfenPingfen=" + kechengPingfenPingfen +
            ", kechengPingfenContent=" + kechengPingfenContent +
