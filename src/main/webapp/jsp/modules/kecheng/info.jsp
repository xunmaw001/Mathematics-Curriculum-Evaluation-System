            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">课程登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengPingfen" name="kechengPingfen" class="form-control"
                                               v-model="ruleForm.kechengPingfen" readonly>
                                    </div>
...
<script>
    ...
    function setDownloadBtn() {
        var kechengFileUrl = "download('" + ruleForm.kechengFile + "')";
        $("#kechengFile").attr("onclick", kechengFileUrl);
