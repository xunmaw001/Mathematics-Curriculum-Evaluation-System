    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">课程评分统计</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">课程评分管理</li>
                        <li class="breadcrumb-item active">课程评分统计</li>
                    </ol>
                </div>
            </div>
        </div>
...
//柱状图 求和 已成功使用
        //start
        let yAxisName = "评分";//根据查询数据具体改(单列要改,多列不改)
        let xAxisName = "课程名称";
        let series = [];//具体数据值
    ...
    function getDetails() {
        ...
        let params = {
            ...
            thisTable : "{" +
            "                tableName :'kecheng'," +
            "                sumColum :'kecheng_pingfen'," +
            "                string :'kecheng_name'," +
            "            }",
        }
        http("/barSum", "GET", params, (res) => {
            draw(res.data,"");
        });
    }
