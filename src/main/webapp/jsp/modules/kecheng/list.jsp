...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="kechengUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="课程编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //课程编号
            var kechengUuidNumberSearchInput = $('#kechengUuidNumberSearch');
            if( kechengUuidNumberSearchInput != null){
                if (kechengUuidNumberSearchInput.val() != null && kechengUuidNumberSearchInput.val() != '') {
                    searchForm.kechengUuidNumber = $('#kechengUuidNumberSearch').val();
                }
            }
        ...
        function getDataList() {
            http("kecheng/page", "GET", {
                ...
                kechengDelete: 1,
                //本表的
                kechengUuidNumber: searchForm.kechengUuidNumber,
        ...
        function setDataRow(item, number) {
            ...
            //课程编号
            var kechengUuidNumberCell = document.createElement('td');
            kechengUuidNumberCell.innerHTML = item.kechengUuidNumber;
            row.appendChild(kechengUuidNumberCell);
            ...
            row.appendChild(kechengTypesCell);
                ...
                //课程视频
            var kechengVideoCell = document.createElement('td');
            var kechengVideo = document.createElement('video');
            var kechengVideoValue = item.kechengVideo;
            if(kechengVideoValue !=null && kechengVideoValue !='' && kechengVideoValue !='null'){
                kechengVideo.setAttribute('src', kechengVideoValue);
                kechengVideo.setAttribute('height', 100);
                kechengVideo.setAttribute('width', 150);
                kechengVideo.setAttribute('controls', 'controls');
                    kechengVideoCell.appendChild(kechengVideo);
            }else{
                    kechengVideoCell.innerHTML = "暂无视频";
            }
            row.appendChild(kechengVideoCell);


                //课程文件
            var kechengFileCell = document.createElement('td');
            if(item.kechengFile ==null || item.kechengFile == '' || item.kechengFile == 'null'){
                    kechengFileCell.innerHTML = '没有下载文件';
            }else {
                var kechengFileFile = document.createElement('button');
                    kechengFileFile.innerHTML = '下载';
                var kechengFileFileAttr = "download('" + item.kechengFile + "')"
                    kechengFileFile.setAttribute('onclick',kechengFileFileAttr);
                    kechengFileCell.appendChild(kechengFileFile);
            }
            row.appendChild(kechengFileCell);


            //课程评分
            var kechengPingfenCell = document.createElement('td');
            kechengPingfenCell.innerHTML = item.kechengPingfen;
            row.appendChild(kechengPingfenCell);
